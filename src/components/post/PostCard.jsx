...
const PostCard = ({
  ...
  return (
    <div className="bg-green-900 text-white rounded-lg shadow-lg min-w-64 max-w-lg mx-auto p-4">
      <div className="flex justify-between items-center mb-4">
        <div className="flex items-center space-x-3">
          <img
            src={profilePic}
            alt="User"
            className="w-10 h-10 rounded-full border-solid border"
          />
          <div>
            <h3 className="font-semibold text-lg">{creatorName}</h3>
            <p className="text-sm text-gray-300">{creatorSubTitle}</p>
          </div>
        </div>
